...
globals_1.expect.extend({
    toContainXPath: function (page, xpath) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, page.waitForXPath(xpath)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, { pass: true }];
                    case 2:
                        e_1 = _a.sent();
                        return [2 /*return*/, { pass: false, message: function () { return "XPath not found: " + xpath; } }];
                    case 3: return [2 /*return*/];
                }
            });
        });
    },
    toClickXPath: function (page, xpath) {
        return __awaiter(this, void 0, void 0, function () {
            var e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    toFillXPath: function (page, xpath, text) {
        return __awaiter(this, void 0, void 0, function () {
            var input, e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
